        ...
        ?>
            <a href="<?= BASE_URL ?>category-detail.php?slug=<?= urlencode(fab_slug($cat['name'])) ?>"
               ...
               data-aos="fade-up" data-aos-delay="<?= ($i % 6) * 60 ?>">
                ...
                <!-- ✅ Category Image - Bada size -->
                <div class="w-16 h-16 rounded-2xl overflow-hidden shrink-0 shadow-[0_8px_16px_rgba(36,30,26,0.15)] transition-transform duration-300 group-hover:scale-105">
